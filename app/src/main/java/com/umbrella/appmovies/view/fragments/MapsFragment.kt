...
import com.umbrella.appmovies.databinding.FragmentMapsBinding
...
class MapsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            findBirthPlace(it.getString(ARG_PLACE_OF_BIRTH, ""))
        }
        initSearchByAddress()
    }
    ...
    private fun findBirthPlace(birthPlace: String) {
        val geoCoder = Geocoder(binding.buttonSearch.context)
        binding.searchAddress.setText(birthPlace)
        val searchText = binding.searchAddress.text.toString()
        Thread {
            try {
                val addresses = geoCoder.getFromLocationName(searchText, 1)
